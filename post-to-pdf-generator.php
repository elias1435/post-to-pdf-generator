...
add_filter('the_content', function ($content) {
    if (is_singular('post') && in_the_loop() && is_main_query()) {
        ...
        $buttons .= '<a id="preview-html-btn" href="' . esc_url($preview_link) . '" target="_blank" rel="nofollow" style="' . $style . '">🔍 Preview PDF HTML</a>';
        $buttons .= '</div>';
